...
- **1–15 人本地传阅**（1 人即单人挑战）——一台设备围一圈轮流博
- **联机对战**——开局页点「🌐 联机对战」创建房间，把 4 位房间号发给朋友即可加入（房间上限 20 人，实测 15 人内体验最佳）；
...
- **音频页面内合成**——撞碗声按真实录音实测重建（共振频率 / 余韵 / 频谱都对录音量过），
  在页面里算出波形再播放，不依赖任何音频文件
- 战绩历史（存本地）
...
所有视觉用内联 SVG / CSS 画出来，所有音效在页面内用 WebAudio 合成，不引任何外部文件。
